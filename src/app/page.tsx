    ...
    <div className="min-h-screen flex flex-col">
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <Image src="/images/palboti.png" alt="PalBoti Logo" width={40} height={40} className="animate-float" />
        ...
        <section className="py-20 md:py-28 animate-pulse-shadow">
          <div className="container flex flex-col items-center text-center">
            <div className="mb-10 flex items-center justify-center">
              <Image src="/images/nest.png" alt="NEST Hackathon" width={200} height={100} className="mr-4" />
              <Image src="/images/palboti.png" alt="PalBoti Logo" width={100} height={100} className="animate-float" />
            </div>
            ...
            <p className="max-w-[700px] text-lg text-muted-foreground md:text-xl mb-8">
              An end-to-end web application that interfaces with an autonomous robot to manage product classification,
              storage, and retrieval in a warehouse setting.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-lg mb-4">
                  Develop an end-to-end web application that interfaces with an autonomous robot to manage product
                  classification, storage, and retrieval in a warehouse setting.
                </p>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-card p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <h3 className="font-bold text-xl mb-2">Mechatronics Engineers</h3>
                <p className="text-muted-foreground">
                  Designing and implementing the robotic hardware and control systems for warehouse automation.
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <h3 className="font-bold text-xl mb-2">Embedded Systems Engineer</h3>
                <p className="text-muted-foreground">
                  Developing the firmware and communication protocols for the robot's real-time operations.
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <h3 className="font-bold text-xl mb-2">AI Engineer</h3>
                <p className="text-muted-foreground">
                  Creating intelligent algorithms for product classification and optimal warehouse navigation.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4 md:h-16">
          <p className="text-sm text-muted-foreground">© 2025 PalBoti Team. All rights reserved.</p>
          <div className="flex items-center gap-4">
