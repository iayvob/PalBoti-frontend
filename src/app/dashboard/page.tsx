      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <div className="col-span-1 md:col-span-2 lg:col-span-3">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold mb-2 text-primary">Warehouse Overview</h1>
            ...
            <div className="mt-4 md:mt-0">
              <div className="flex items-center bg-secondary/50 p-2 rounded-lg">
                <Image src="/images/nest.png" alt="NEST Hackathon" width={80} height={40} className="mr-2" />
                <span className="text-sm font-medium">NEST Hackathon Project</span>
              </div>
            </div>
          </div>
        </div>
